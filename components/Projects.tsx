...
const projects = [
  ...
  },
  {
    ...
    category: 'Web Development',
    technologies: ['React', 'Node.js', 'Next.js', 'PostgreSQL' ,  'Tailwind CSS'],
    liveUrl: '#',
  ...
  },
  {
    ...
    description: 'A futuristic portfolio website with interactive elements, and modern design principles.',
...
const categories = [
  ...
  { id: 'Mobile Development', name: 'Mobile Apps', icon: Code },
